<!-- pm-progress-entry.template.md
     ...
     Column order: when | story | base | branch | state | commit | pr | human_validation | notes | cost | spec

     `cost` and `spec` are appended LAST, in the order they were added, for the same reason:
     ...
     | when | story | base | branch | state | commit | pr | human_validation | notes | cost | spec |
     |---|---|---|---|---|---|---|---|---|---|---|
-->
| {{when}} | {{story}} | {{base}} | {{branch}} | {{state}} | {{commit}} | {{pr}} | {{human_validation}} | {{notes}} | {{cost}} | {{spec}} |
