...
Opencode port of the Claude `spec-driven-eval` skill. Follow this methodology exactly when the user explicitly asks to run `spec-driven-eval`; do not auto-trigger it for general planning, implementation, or code review requests.
